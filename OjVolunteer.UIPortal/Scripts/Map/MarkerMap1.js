...
var BaiduMapObj = (function () {
    ...
    this.addM1 = function (map) {
        ...
        (function () {
            ...
            var sContent = "<h4 style=' margin:0 0 5px 0;padding:0.2em 0;'><a style='color:black;' href='/Activity/Details/?Id="
                ...
                + "志愿者计算机维修"
                + "</a></h4>"
                + "<video src='../Scripts/Map/1.mp4' poster = 'images/snow.jpg' width = '320' height = '240' controls  autoplay=true loop > <p>A video of snow in WHU</p> </video >"
    ...
    this.addM2 = function (map) {
        ...
        (function () {
            ...
            var sContent = "<h4 style=' margin:0 0 5px 0;padding:0.2em 0;'><a style='color:black;' href='/Activity/Details/?Id="
                ...
                + "红话筒志愿服务"
                + "</a></h4>"
                + "<video src='../Scripts/Map/2.mp4' poster = 'images/snow.jpg' width = '320' height = '240' controls  autoplay=true loop > <p>A video of snow in WHU</p> </video >"
    ...
    this.addMarker = function (map, markerArr) {
        for (var i = 0; i < markerArr.length; i++) {
            ...
            var point = new BMap.Point(p0, p1);
            var iconImg;
            AllTime += json.ActTime * json.ActNum;//总时间
            if (json.ActStatus == "0") {
                if (json.ActType == "1") {
                    iconImg = icon[1];
                }
            ...
            var marker = new BMap.Marker(point,{icon:iconImg });//创建图标 , { icon: iconImg }
            marker.setTime(json.ActTime * json.ActNum);//在marker里添加时间*人数
    ...
    this.show = function (checkbox) {
        ...
        $("#times").html("目前志愿者总时长为:" + hhhsum.toFixed(2));
